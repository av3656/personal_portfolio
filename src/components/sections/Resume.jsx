  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        ...
        <Reveal>
          <div className="overflow-hidden rounded-3xl border border-ai-border bg-ai-card/80 shadow-lg shadow-slate-900/10 backdrop-blur dark:border-ai-border dark:bg-ai-card/80">
